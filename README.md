...
Will be deployed to the releases directory, and then rsynced to the `htdocs/wp-content/themes` directory with `delete` flag to overwrite any existing matching mu plugin.
